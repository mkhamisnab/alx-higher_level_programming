s
n - Import and Modules

In this project, I explored the concepts of importing and using functions, as well as creating modules in Python. I also practiced using the built-in function `dir()` and working with command line arguments in Python programs.
...
* **2. How to make a script dynamic!**
  * [2-args.py](./2-args.py): Python program that prints the number of arguments and a list of its arguments.
